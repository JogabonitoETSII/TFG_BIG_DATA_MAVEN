...
public class PentahoLogicTest {
	...
	public void test() throws ReportProcessingException, IOException {
		...
		reportSuccess = pentaho.createReportWordCounts("/home/alberto/Escritorio/outputTEST1/", "part-r-00000","\t", columNames, "Palabras", "Cantidad","Palabras", new String[] {""});
		...
		Assert.assertTrue(reportSuccess);*/
	}
